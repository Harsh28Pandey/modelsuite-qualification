...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-[240px] flex flex-col z-50"
      ...
      {/* Footer */}
      <div className="px-3 pb-5 flex flex-col gap-3.5">
        ...
        {/* Explicitly labeled "Logout" button replacing the old obscure raw icon layout */}
        <button
          onClick={() => { logout(); navigate('/login'); }}
          className="nav-item justify-center gap-2 mt-1"
          style={{
